...
function createMain() {
  mainWindow = new BrowserWindow({
    ...
    title: 'İÇDER Dernek Yönetim Programı'
  });
...
app.whenReady().then(() => {
  ...
  try {
    ...
    execSync('netsh advfirewall firewall add rule name="İÇDER Dernek 4500" dir=in action=allow protocol=TCP localport=4500', { stdio: 'ignore' });
  } catch(e) {}
